...
python ../join_dataset_results.py   cropped_test_dataset_32.csv   probabilities.csv   -o test_cropped_test_dataset_32.csv

time \
python ../metrics.py  	-i test_cropped_test_dataset_32.csv  \
			-o test_metrics.txt \
